            ...
            .addComponents(
                new StringSelectMenuBuilder()
                    ...
                    .addOptions([
                        {
                            label: "İban",
                            description: "Verilen İban No'suna ücreti gönderirsiniz.",
                            value: "iban"
                        },
                    ])
...
// discord.gg/altyapilar - Lourity
    ...
    if (interaction.isStringSelectMenu()) {
        ...
        if (interaction.values[0] === 'iban_all') {
            interaction.guild.channels.create({
                ...
                const productEmbed = new EmbedBuilder()
                    ...
                    .addFields(
                        ...
                        { name: "İban No:", value: `\`\`\`${config.iban}\`\`\``, inline: true },
                    )
            ...
            interaction.guild.channels.create({
                ...
                const productEmbed = new EmbedBuilder()
                    ...
                    .addFields(
                        { name: "Ürünlerin Adı:", value: `${main_data.join(', ')}`, inline: true },
                        { name: "Ödenecek Tutar:", value: `**${general_price}₺**`, inline: true },
                        { name: "İban No:", value: `\`\`\`${config.ininal}\`\`\``, inline: true },
                    )
